...
Description:
This script creates the Gold layer views used for business intelligence,
...
These views are built from the cleansed and standardized Silver layer.
...
SELECT
    sd.sls_old_num AS order_number,
    pr.product_key,
    cu.customer_key,
